...
class TestCodeRepairSettingsPayload(BaseModel):
    enabled: bool = True
...
class TestExecutionSummaryPayload(BaseModel):
    command: str
    exit_code: int
    stdout: str = ""
    stderr: str = ""
...
class TestCodeRepairInputPayload(BaseModel):
    task_id: str
    ...
    execution_result: TestExecutionSummaryPayload


class TestCodeRepairRunRequest(BaseModel):
    settings: TestCodeRepairSettingsPayload
    input: TestCodeRepairInputPayload
