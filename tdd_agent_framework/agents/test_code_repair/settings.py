...
class TestCodeRepairAgentSettings:
    enabled: bool
    provider_kind: str
    provider_name: str
    model: str
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "TestCodeRepairAgentSettings":
        if not isinstance(data, dict):
            raise ValueError("test code repair settings must be an object")
