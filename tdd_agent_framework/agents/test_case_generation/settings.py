...
class TestCaseGenerationAgentSettings:
    enabled: bool
    provider_kind: str
    provider_name: str
    model: str
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "TestCaseGenerationAgentSettings":
        if not isinstance(data, dict):
            raise ValueError("test case generation settings must be an object")
...
@dataclass(frozen=True)
class TestCaseGenerationAgentSettingsView:
    enabled: bool
    provider_kind: str
    provider_name: str
    model: str
