...
class TestCodeGenerationAgentSettings:
    enabled: bool
    provider_kind: str
    provider_name: str
    model: str
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "TestCodeGenerationAgentSettings":
        if not isinstance(data, dict):
            raise ValueError("test code generation settings must be an object")
