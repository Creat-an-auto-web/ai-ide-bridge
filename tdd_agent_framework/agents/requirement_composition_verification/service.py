...
from .models import RequirementCompositionVerificationInput


class RequirementCompositionVerificationService:
    def __init__(self, agent: RequirementCompositionVerificationAgent) -> None:
        self.agent = agent
